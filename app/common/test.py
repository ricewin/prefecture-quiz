...
def step1():
    # 都道府県データを取得
    DATA = fetch_data(
        "https://raw.githubusercontent.com/ricewin/simplify-japan-geojson/refs/heads/main/GeoJson/N03-20250101_prefecture.json"
    )
...
def step2():
    ...
    DATA = fetch_data(
        f"https://raw.githubusercontent.com/ricewin/simplify-japan-geojson/refs/heads/main/GeoJson/N03-20250101_{code}.json"
    )
